...
func (gateway *ApplicationGateway) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(nil, gateway.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (gateway *ApplicationGateway) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(nil, gateway.Spec.OperatorSpec.SecretExpressions)
}
