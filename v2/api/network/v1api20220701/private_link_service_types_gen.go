...
func (service *PrivateLinkService) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(toValidate, service.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (service *PrivateLinkService) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(nil, service.Spec.OperatorSpec.SecretExpressions)
}
