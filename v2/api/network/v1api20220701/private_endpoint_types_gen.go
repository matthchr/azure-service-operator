...
func (endpoint *PrivateEndpoint) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(toValidate, endpoint.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (endpoint *PrivateEndpoint) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(nil, endpoint.Spec.OperatorSpec.SecretExpressions)
}
