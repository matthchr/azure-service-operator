...
func (host *BastionHost) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(nil, host.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (host *BastionHost) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(nil, host.Spec.OperatorSpec.SecretExpressions)
}
