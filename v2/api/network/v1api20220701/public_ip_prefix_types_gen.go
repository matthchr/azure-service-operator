...
func (prefix *PublicIPPrefix) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(nil, prefix.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (prefix *PublicIPPrefix) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(nil, prefix.Spec.OperatorSpec.SecretExpressions)
}
