...
func (resolver *DnsResolver) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(nil, resolver.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (resolver *DnsResolver) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(nil, resolver.Spec.OperatorSpec.SecretExpressions)
}
