...
func (record *PrivateDnsZonesPTRRecord) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(nil, record.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (record *PrivateDnsZonesPTRRecord) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(nil, record.Spec.OperatorSpec.SecretExpressions)
}
...
func (zonesPTR *PrivateDnsZones_PTR_Spec) AssignProperties_From_PrivateDnsZones_PTR_Spec(source *storage.PrivateDnsZones_PTR_Spec) error {
	...
	if source.OperatorSpec != nil {
		...
		zonesPTR.OperatorSpec = &operatorSpec
	} else {
		zonesPTR.OperatorSpec = nil
	}
...
func (zonesPTR *PrivateDnsZones_PTR_Spec) AssignProperties_To_PrivateDnsZones_PTR_Spec(destination *storage.PrivateDnsZones_PTR_Spec) error {
	...
	// OperatorSpec
	if zonesPTR.OperatorSpec != nil {
		var operatorSpec storage.PrivateDnsZonesPTRRecordOperatorSpec
		err := zonesPTR.OperatorSpec.AssignProperties_To_PrivateDnsZonesPTRRecordOperatorSpec(&operatorSpec)
		if err != nil {
