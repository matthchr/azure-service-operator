...
func (zonesA *PrivateDnsZones_A_Spec) AssignProperties_From_PrivateDnsZones_A_Spec(source *storage.PrivateDnsZones_A_Spec) error {
	...
	if source.OperatorSpec != nil {
		...
		zonesA.OperatorSpec = &operatorSpec
	} else {
		zonesA.OperatorSpec = nil
	}
...
func (zonesA *PrivateDnsZones_A_Spec) AssignProperties_To_PrivateDnsZones_A_Spec(destination *storage.PrivateDnsZones_A_Spec) error {
	...
	// OperatorSpec
	if zonesA.OperatorSpec != nil {
		var operatorSpec storage.PrivateDnsZonesARecordOperatorSpec
		err := zonesA.OperatorSpec.AssignProperties_To_PrivateDnsZonesARecordOperatorSpec(&operatorSpec)
		if err != nil {
