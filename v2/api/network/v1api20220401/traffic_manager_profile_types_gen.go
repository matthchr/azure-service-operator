...
func (profile *TrafficManagerProfile) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(toValidate, profile.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (profile *TrafficManagerProfile) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(nil, profile.Spec.OperatorSpec.SecretExpressions)
}
