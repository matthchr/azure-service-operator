...
func (balancer *LoadBalancer) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(nil, balancer.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (balancer *LoadBalancer) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(nil, balancer.Spec.OperatorSpec.SecretExpressions)
}
