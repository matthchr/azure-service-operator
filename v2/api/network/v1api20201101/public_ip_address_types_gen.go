...
func (address *PublicIPAddress) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(nil, address.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (address *PublicIPAddress) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(nil, address.Spec.OperatorSpec.SecretExpressions)
}
