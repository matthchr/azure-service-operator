...
// We first initialize routeTables_Route_SpecGenerator with a simplified generator based on the
...
func RouteTables_Route_SpecGenerator() gopter.Gen {
	...
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForRouteTables_Route_Spec(generators)
	AddRelatedPropertyGeneratorsForRouteTables_Route_Spec(generators)
	routeTables_Route_SpecGenerator = gen.Struct(reflect.TypeOf(RouteTables_Route_Spec{}), generators)
...
// AddRelatedPropertyGeneratorsForRouteTables_Route_Spec is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForRouteTables_Route_Spec(gens map[string]gopter.Gen) {
