...
func (networkInterface *NetworkInterface) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(nil, networkInterface.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (networkInterface *NetworkInterface) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(nil, networkInterface.Spec.OperatorSpec.SecretExpressions)
}
