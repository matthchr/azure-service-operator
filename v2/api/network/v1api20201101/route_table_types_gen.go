...
func (table *RouteTable) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(nil, table.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (table *RouteTable) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(nil, table.Spec.OperatorSpec.SecretExpressions)
}
