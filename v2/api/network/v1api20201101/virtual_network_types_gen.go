...
func (network *VirtualNetwork) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(nil, network.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (network *VirtualNetwork) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(nil, network.Spec.OperatorSpec.SecretExpressions)
}
