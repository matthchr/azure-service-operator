...
func (zone *PrivateDnsZone) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(nil, zone.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (zone *PrivateDnsZone) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(nil, zone.Spec.OperatorSpec.SecretExpressions)
}
