...
func (vault *BackupVault) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(toValidate, vault.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (vault *BackupVault) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(nil, vault.Spec.OperatorSpec.SecretExpressions)
}
