...
func (extension *Extension) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(toValidate, extension.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (extension *Extension) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(nil, extension.Spec.OperatorSpec.SecretExpressions)
}
