...
func (signalR *SignalR) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(nil, signalR.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (signalR *SignalR) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(toValidate, signalR.Spec.OperatorSpec.SecretExpressions)
}
