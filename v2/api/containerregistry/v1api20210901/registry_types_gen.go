...
func (registry *Registry) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(nil, registry.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (registry *Registry) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(nil, registry.Spec.OperatorSpec.SecretExpressions)
}
