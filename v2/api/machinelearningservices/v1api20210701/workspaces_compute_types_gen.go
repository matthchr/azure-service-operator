...
func (compute *WorkspacesCompute) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(nil, compute.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (compute *WorkspacesCompute) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(nil, compute.Spec.OperatorSpec.SecretExpressions)
}
