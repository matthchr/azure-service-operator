...
func (workspace *Workspace) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(nil, workspace.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (workspace *Workspace) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(toValidate, workspace.Spec.OperatorSpec.SecretExpressions)
}
