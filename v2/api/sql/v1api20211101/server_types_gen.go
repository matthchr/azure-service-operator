...
func (server *Server) ExportKubernetesConfigMaps(_ context.Context) ([]client.Object, error) {
...
func (server *Server) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(nil, server.Spec.OperatorSpec.SecretExpressions)
}
