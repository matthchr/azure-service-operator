...
// We first initialize servers_AdvancedThreatProtectionSetting_SpecGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func Servers_AdvancedThreatProtectionSetting_SpecGenerator() gopter.Gen {
	...
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForServers_AdvancedThreatProtectionSetting_Spec(generators)
	AddRelatedPropertyGeneratorsForServers_AdvancedThreatProtectionSetting_Spec(generators)
	servers_AdvancedThreatProtectionSetting_SpecGenerator = gen.Struct(reflect.TypeOf(Servers_AdvancedThreatProtectionSetting_Spec{}), generators)
...
// AddRelatedPropertyGeneratorsForServers_AdvancedThreatProtectionSetting_Spec is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForServers_AdvancedThreatProtectionSetting_Spec(gens map[string]gopter.Gen) {
