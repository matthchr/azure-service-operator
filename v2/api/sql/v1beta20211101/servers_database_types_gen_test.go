...
func Test_Servers_Database_WhenConvertedToHub_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties.Property(
		"Round trip from Servers_Database to hub returns original",
		prop.ForAll(RunResourceConversionTestForServers_Database, Servers_DatabaseGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunResourceConversionTestForServers_Database tests if a specific instance of Servers_Database round trips to the hub storage version and back losslessly
func RunResourceConversionTestForServers_Database(subject Servers_Database) string {
	// Copy subject to make sure conversion doesn't modify it
	copied := subject.DeepCopy()

	// Convert to our hub version
	var hub v20211101s.Servers_Database
...
func Test_Servers_Database_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from Servers_Database to Servers_Database via AssignProperties_To_Servers_Database & AssignProperties_From_Servers_Database returns original",
		prop.ForAll(RunPropertyAssignmentTestForServers_Database, Servers_DatabaseGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForServers_Database tests if a specific instance of Servers_Database can be assigned to v1beta20211101storage and back losslessly
func RunPropertyAssignmentTestForServers_Database(subject Servers_Database) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20211101s.Servers_Database
	err := copied.AssignProperties_To_Servers_Database(&other)
	if err != nil {
		return err.Error()
	}
	...
	var actual Servers_Database
	err = actual.AssignProperties_From_Servers_Database(&other)
	if err != nil {
		return err.Error()
	}
