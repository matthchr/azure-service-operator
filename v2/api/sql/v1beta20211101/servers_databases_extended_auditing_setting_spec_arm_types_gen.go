...
type Servers_Databases_ExtendedAuditingSetting_Spec_ARM struct {
	Name string `json:"name,omitempty"`

	// Properties: Resource properties.
	Properties *ExtendedDatabaseBlobAuditingPolicyProperties_ARM `json:"properties,omitempty"`
}

var _ genruntime.ARMResourceSpec = &Servers_Databases_ExtendedAuditingSetting_Spec_ARM{}

// GetAPIVersion returns the ARM API version of the resource. This is always "2021-11-01"
func (setting Servers_Databases_ExtendedAuditingSetting_Spec_ARM) GetAPIVersion() string {
	return string(APIVersion_Value)
}

// GetName returns the Name of the resource
func (setting *Servers_Databases_ExtendedAuditingSetting_Spec_ARM) GetName() string {
	return setting.Name
}

// GetType returns the ARM Type of the resource. This is always "Microsoft.Sql/servers/databases/extendedAuditingSettings"
func (setting *Servers_Databases_ExtendedAuditingSetting_Spec_ARM) GetType() string {
	return "Microsoft.Sql/servers/databases/extendedAuditingSettings"
}

// Properties of an extended database blob auditing policy.
type ExtendedDatabaseBlobAuditingPolicyProperties_ARM struct {
