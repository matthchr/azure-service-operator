...
type ManagedInstances_Databases_SecurityAlertPolicy_STATUS_ARM struct {
	// Id: Resource ID.
	...
	Properties *SecurityAlertPolicyProperties_STATUS_ARM `json:"properties,omitempty"`
...
type SecurityAlertPolicyProperties_STATUS_ARM struct {
