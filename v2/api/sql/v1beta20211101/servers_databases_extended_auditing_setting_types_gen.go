...
var _ conversion.Convertible = &Servers_Databases_ExtendedAuditingSetting{}

// ConvertFrom populates our Servers_Databases_ExtendedAuditingSetting from the provided hub Servers_Databases_ExtendedAuditingSetting
func (setting *Servers_Databases_ExtendedAuditingSetting) ConvertFrom(hub conversion.Hub) error {
	source, ok := hub.(*v20211101s.Servers_Databases_ExtendedAuditingSetting)
	if !ok {
		return fmt.Errorf("expected sql/v1beta20211101storage/Servers_Databases_ExtendedAuditingSetting but received %T instead", hub)
	}

	return setting.AssignProperties_From_Servers_Databases_ExtendedAuditingSetting(source)
}

// ConvertTo populates the provided hub Servers_Databases_ExtendedAuditingSetting from our Servers_Databases_ExtendedAuditingSetting
func (setting *Servers_Databases_ExtendedAuditingSetting) ConvertTo(hub conversion.Hub) error {
	destination, ok := hub.(*v20211101s.Servers_Databases_ExtendedAuditingSetting)
	if !ok {
		return fmt.Errorf("expected sql/v1beta20211101storage/Servers_Databases_ExtendedAuditingSetting but received %T instead", hub)
	}

	return setting.AssignProperties_To_Servers_Databases_ExtendedAuditingSetting(destination)
}

// +kubebuilder:webhook:path=/mutate-sql-azure-com-v1beta20211101-servers_databases_extendedauditingsetting,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=sql.azure.com,resources=servers_databases_extendedauditingsettings,verbs=create;update,versions=v1beta20211101,name=default.v1beta20211101.servers_databases_extendedauditingsettings.sql.azure.com,admissionReviewVersions=v1

var _ admission.Defaulter = &Servers_Databases_ExtendedAuditingSetting{}

// Default applies defaults to the Servers_Databases_ExtendedAuditingSetting resource
func (setting *Servers_Databases_ExtendedAuditingSetting) Default() {
	setting.defaultImpl()
...
// defaultImpl applies the code generated defaults to the Servers_Databases_ExtendedAuditingSetting resource
func (setting *Servers_Databases_ExtendedAuditingSetting) defaultImpl() {}
...
// +kubebuilder:webhook:path=/validate-sql-azure-com-v1beta20211101-servers_databases_extendedauditingsetting,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=sql.azure.com,resources=servers_databases_extendedauditingsettings,verbs=create;update,versions=v1beta20211101,name=validate.v1beta20211101.servers_databases_extendedauditingsettings.sql.azure.com,admissionReviewVersions=v1

var _ admission.Validator = &Servers_Databases_ExtendedAuditingSetting{}

// ValidateCreate validates the creation of the resource
func (setting *Servers_Databases_ExtendedAuditingSetting) ValidateCreate() error {
...
func (setting *Servers_Databases_ExtendedAuditingSetting) ValidateDelete() error {
...
func (setting *Servers_Databases_ExtendedAuditingSetting) ValidateUpdate(old runtime.Object) error {
...
func (setting *Servers_Databases_ExtendedAuditingSetting) createValidations() []func() error {
	return []func() error{setting.validateResourceReferences}
}

// deleteValidations validates the deletion of the resource
func (setting *Servers_Databases_ExtendedAuditingSetting) deleteValidations() []func() error {
	return nil
}

// updateValidations validates the update of the resource
func (setting *Servers_Databases_ExtendedAuditingSetting) updateValidations() []func(old runtime.Object) error {
...
func (setting *Servers_Databases_ExtendedAuditingSetting) validateResourceReferences() error {
...
func (setting *Servers_Databases_ExtendedAuditingSetting) validateWriteOnceProperties(old runtime.Object) error {
	oldObj, ok := old.(*Servers_Databases_ExtendedAuditingSetting)
	if !ok {
		return nil
	}
...
// AssignProperties_From_Servers_Databases_ExtendedAuditingSetting populates our Servers_Databases_ExtendedAuditingSetting from the provided source Servers_Databases_ExtendedAuditingSetting
func (setting *Servers_Databases_ExtendedAuditingSetting) AssignProperties_From_Servers_Databases_ExtendedAuditingSetting(source *v20211101s.Servers_Databases_ExtendedAuditingSetting) error {

	// ObjectMeta
	setting.ObjectMeta = *source.ObjectMeta.DeepCopy()

	// Spec
	var spec Servers_Databases_ExtendedAuditingSetting_Spec
	err := spec.AssignProperties_From_Servers_Databases_ExtendedAuditingSetting_Spec(&source.Spec)
	if err != nil {
		return errors.Wrap(err, "calling AssignProperties_From_Servers_Databases_ExtendedAuditingSetting_Spec() to populate field Spec")
	}
	setting.Spec = spec

	// Status
	var status Servers_Databases_ExtendedAuditingSetting_STATUS
	err = status.AssignProperties_From_Servers_Databases_ExtendedAuditingSetting_STATUS(&source.Status)
	if err != nil {
		return errors.Wrap(err, "calling AssignProperties_From_Servers_Databases_ExtendedAuditingSetting_STATUS() to populate field Status")
	}
...
// AssignProperties_To_Servers_Databases_ExtendedAuditingSetting populates the provided destination Servers_Databases_ExtendedAuditingSetting from our Servers_Databases_ExtendedAuditingSetting
func (setting *Servers_Databases_ExtendedAuditingSetting) AssignProperties_To_Servers_Databases_ExtendedAuditingSetting(destination *v20211101s.Servers_Databases_ExtendedAuditingSetting) error {

	// ObjectMeta
	destination.ObjectMeta = *setting.ObjectMeta.DeepCopy()

	// Spec
	var spec v20211101s.Servers_Databases_ExtendedAuditingSetting_Spec
	err := setting.Spec.AssignProperties_To_Servers_Databases_ExtendedAuditingSetting_Spec(&spec)
	if err != nil {
		return errors.Wrap(err, "calling AssignProperties_To_Servers_Databases_ExtendedAuditingSetting_Spec() to populate field Spec")
	}
	destination.Spec = spec

	// Status
	var status v20211101s.Servers_Databases_ExtendedAuditingSetting_STATUS
	err = setting.Status.AssignProperties_To_Servers_Databases_ExtendedAuditingSetting_STATUS(&status)
	if err != nil {
		return errors.Wrap(err, "calling AssignProperties_To_Servers_Databases_ExtendedAuditingSetting_STATUS() to populate field Status")
	}
...
type Servers_Databases_ExtendedAuditingSetting_Spec struct {
	...
	// required.
	State *ExtendedDatabaseBlobAuditingPolicyProperties_State `json:"state,omitempty"`
...
var _ genruntime.ARMTransformer = &Servers_Databases_ExtendedAuditingSetting_Spec{}

// ConvertToARM converts from a Kubernetes CRD object to an ARM object
func (setting *Servers_Databases_ExtendedAuditingSetting_Spec) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	if setting == nil {
		return nil, nil
	}
	result := &Servers_Databases_ExtendedAuditingSetting_Spec_ARM{}
	...
	if setting.AuditActionsAndGroups != nil ||
		...
		setting.PredicateExpression != nil ||
		...
		result.Properties = &ExtendedDatabaseBlobAuditingPolicyProperties_ARM{}
	}
	...
	if setting.PredicateExpression != nil {
		predicateExpression := *setting.PredicateExpression
		result.Properties.PredicateExpression = &predicateExpression
	}
...
func (setting *Servers_Databases_ExtendedAuditingSetting_Spec) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &Servers_Databases_ExtendedAuditingSetting_Spec_ARM{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (setting *Servers_Databases_ExtendedAuditingSetting_Spec) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(Servers_Databases_ExtendedAuditingSetting_Spec_ARM)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected Servers_Databases_ExtendedAuditingSetting_Spec_ARM, got %T", armInput)
	}
	...
	// Set property ‘PredicateExpression’:
	// copying flattened property:
	if typedInput.Properties != nil {
		if typedInput.Properties.PredicateExpression != nil {
			predicateExpression := *typedInput.Properties.PredicateExpression
			setting.PredicateExpression = &predicateExpression
		}
	}
...
func (setting *Servers_Databases_ExtendedAuditingSetting_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*v20211101s.Servers_Databases_ExtendedAuditingSetting_Spec)
	if ok {
		// Populate our instance from source
		return setting.AssignProperties_From_Servers_Databases_ExtendedAuditingSetting_Spec(src)
	}

	// Convert to an intermediate form
	src = &v20211101s.Servers_Databases_ExtendedAuditingSetting_Spec{}
	...
	err = setting.AssignProperties_From_Servers_Databases_ExtendedAuditingSetting_Spec(src)
	if err != nil {
...
func (setting *Servers_Databases_ExtendedAuditingSetting_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*v20211101s.Servers_Databases_ExtendedAuditingSetting_Spec)
	if ok {
		// Populate destination from our instance
		return setting.AssignProperties_To_Servers_Databases_ExtendedAuditingSetting_Spec(dst)
	}

	// Convert to an intermediate form
	dst = &v20211101s.Servers_Databases_ExtendedAuditingSetting_Spec{}
	err := setting.AssignProperties_To_Servers_Databases_ExtendedAuditingSetting_Spec(dst)
	if err != nil {
...
// AssignProperties_From_Servers_Databases_ExtendedAuditingSetting_Spec populates our Servers_Databases_ExtendedAuditingSetting_Spec from the provided source Servers_Databases_ExtendedAuditingSetting_Spec
func (setting *Servers_Databases_ExtendedAuditingSetting_Spec) AssignProperties_From_Servers_Databases_ExtendedAuditingSetting_Spec(source *v20211101s.Servers_Databases_ExtendedAuditingSetting_Spec) error {
	...
	// PredicateExpression
	setting.PredicateExpression = genruntime.ClonePointerToString(source.PredicateExpression)
	...
	// State
	if source.State != nil {
		state := ExtendedDatabaseBlobAuditingPolicyProperties_State(*source.State)
		setting.State = &state
	} else {
		setting.State = nil
	}
...
// AssignProperties_To_Servers_Databases_ExtendedAuditingSetting_Spec populates the provided destination Servers_Databases_ExtendedAuditingSetting_Spec from our Servers_Databases_ExtendedAuditingSetting_Spec
func (setting *Servers_Databases_ExtendedAuditingSetting_Spec) AssignProperties_To_Servers_Databases_ExtendedAuditingSetting_Spec(destination *v20211101s.Servers_Databases_ExtendedAuditingSetting_Spec) error {
	...
	// PredicateExpression
	destination.PredicateExpression = genruntime.ClonePointerToString(setting.PredicateExpression)
...
func (setting *Servers_Databases_ExtendedAuditingSetting_Spec) OriginalVersion() string {
...
type Servers_Databases_ExtendedAuditingSetting_STATUS struct {
	...
	// State: Specifies the state of the audit. If state is Enabled, storageEndpoint or isAzureMonitorTargetEnabled are
	// required.
	State *ExtendedDatabaseBlobAuditingPolicyProperties_State_STATUS `json:"state,omitempty"`
...
func (setting *Servers_Databases_ExtendedAuditingSetting_STATUS) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*v20211101s.Servers_Databases_ExtendedAuditingSetting_STATUS)
	if ok {
		// Populate our instance from source
		return setting.AssignProperties_From_Servers_Databases_ExtendedAuditingSetting_STATUS(src)
	}

	// Convert to an intermediate form
	src = &v20211101s.Servers_Databases_ExtendedAuditingSetting_STATUS{}
	...
	// Update our instance from src
	err = setting.AssignProperties_From_Servers_Databases_ExtendedAuditingSetting_STATUS(src)
	if err != nil {
...
func (setting *Servers_Databases_ExtendedAuditingSetting_STATUS) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*v20211101s.Servers_Databases_ExtendedAuditingSetting_STATUS)
	if ok {
		// Populate destination from our instance
		return setting.AssignProperties_To_Servers_Databases_ExtendedAuditingSetting_STATUS(dst)
	}

	// Convert to an intermediate form
	dst = &v20211101s.Servers_Databases_ExtendedAuditingSetting_STATUS{}
	err := setting.AssignProperties_To_Servers_Databases_ExtendedAuditingSetting_STATUS(dst)
	if err != nil {
...
var _ genruntime.FromARMConverter = &Servers_Databases_ExtendedAuditingSetting_STATUS{}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (setting *Servers_Databases_ExtendedAuditingSetting_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &Servers_Databases_ExtendedAuditingSetting_STATUS_ARM{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (setting *Servers_Databases_ExtendedAuditingSetting_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(Servers_Databases_ExtendedAuditingSetting_STATUS_ARM)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected Servers_Databases_ExtendedAuditingSetting_STATUS_ARM, got %T", armInput)
	}
...
// AssignProperties_From_Servers_Databases_ExtendedAuditingSetting_STATUS populates our Servers_Databases_ExtendedAuditingSetting_STATUS from the provided source Servers_Databases_ExtendedAuditingSetting_STATUS
func (setting *Servers_Databases_ExtendedAuditingSetting_STATUS) AssignProperties_From_Servers_Databases_ExtendedAuditingSetting_STATUS(source *v20211101s.Servers_Databases_ExtendedAuditingSetting_STATUS) error {
	...
	// State
	if source.State != nil {
		state := ExtendedDatabaseBlobAuditingPolicyProperties_State_STATUS(*source.State)
		setting.State = &state
	} else {
		setting.State = nil
	}
...
// AssignProperties_To_Servers_Databases_ExtendedAuditingSetting_STATUS populates the provided destination Servers_Databases_ExtendedAuditingSetting_STATUS from our Servers_Databases_ExtendedAuditingSetting_STATUS
func (setting *Servers_Databases_ExtendedAuditingSetting_STATUS) AssignProperties_To_Servers_Databases_ExtendedAuditingSetting_STATUS(destination *v20211101s.Servers_Databases_ExtendedAuditingSetting_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
type ExtendedDatabaseBlobAuditingPolicyProperties_State string

const (
	ExtendedDatabaseBlobAuditingPolicyProperties_State_Disabled = ExtendedDatabaseBlobAuditingPolicyProperties_State("Disabled")
	ExtendedDatabaseBlobAuditingPolicyProperties_State_Enabled  = ExtendedDatabaseBlobAuditingPolicyProperties_State("Enabled")
)

type ExtendedDatabaseBlobAuditingPolicyProperties_State_STATUS string

const (
	ExtendedDatabaseBlobAuditingPolicyProperties_State_STATUS_Disabled = ExtendedDatabaseBlobAuditingPolicyProperties_State_STATUS("Disabled")
	ExtendedDatabaseBlobAuditingPolicyProperties_State_STATUS_Enabled  = ExtendedDatabaseBlobAuditingPolicyProperties_State_STATUS("Enabled")
)
