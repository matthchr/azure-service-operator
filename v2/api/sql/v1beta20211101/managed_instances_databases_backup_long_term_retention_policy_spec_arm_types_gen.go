...
type ManagedInstances_Databases_BackupLongTermRetentionPolicy_Spec_ARM struct {
...
var _ genruntime.ARMResourceSpec = &ManagedInstances_Databases_BackupLongTermRetentionPolicy_Spec_ARM{}

// GetAPIVersion returns the ARM API version of the resource. This is always "2021-11-01"
func (policy ManagedInstances_Databases_BackupLongTermRetentionPolicy_Spec_ARM) GetAPIVersion() string {
	return string(APIVersion_Value)
}

// GetName returns the Name of the resource
func (policy *ManagedInstances_Databases_BackupLongTermRetentionPolicy_Spec_ARM) GetName() string {
	return policy.Name
}
...
func (policy *ManagedInstances_Databases_BackupLongTermRetentionPolicy_Spec_ARM) GetType() string {
