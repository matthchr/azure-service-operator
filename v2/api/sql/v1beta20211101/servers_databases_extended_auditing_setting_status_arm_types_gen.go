...
type Servers_Databases_ExtendedAuditingSetting_STATUS_ARM struct {
	// Id: Resource ID.
	...
	Properties *ExtendedDatabaseBlobAuditingPolicyProperties_STATUS_ARM `json:"properties,omitempty"`
...
type ExtendedDatabaseBlobAuditingPolicyProperties_STATUS_ARM struct {
