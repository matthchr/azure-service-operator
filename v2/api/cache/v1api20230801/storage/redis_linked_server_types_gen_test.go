...
// We first initialize redis_LinkedServer_SpecGenerator with a simplified generator based on the
...
func Redis_LinkedServer_SpecGenerator() gopter.Gen {
	...
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForRedis_LinkedServer_Spec(generators)
	AddRelatedPropertyGeneratorsForRedis_LinkedServer_Spec(generators)
	redis_LinkedServer_SpecGenerator = gen.Struct(reflect.TypeOf(Redis_LinkedServer_Spec{}), generators)
...
// AddRelatedPropertyGeneratorsForRedis_LinkedServer_Spec is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForRedis_LinkedServer_Spec(gens map[string]gopter.Gen) {
