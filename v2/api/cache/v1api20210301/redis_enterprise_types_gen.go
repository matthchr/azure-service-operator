...
func (enterprise *RedisEnterprise) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(nil, enterprise.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (enterprise *RedisEnterprise) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(nil, enterprise.Spec.OperatorSpec.SecretExpressions)
}
