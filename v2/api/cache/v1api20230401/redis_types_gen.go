...
func (redis *Redis) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(nil, redis.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (redis *Redis) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(toValidate, redis.Spec.OperatorSpec.SecretExpressions)
}
