...
func (schedule *RedisPatchSchedule) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(nil, schedule.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (schedule *RedisPatchSchedule) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(nil, schedule.Spec.OperatorSpec.SecretExpressions)
}
