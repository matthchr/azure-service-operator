...
func (assignment *RoleAssignment) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(nil, assignment.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (assignment *RoleAssignment) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(nil, assignment.Spec.OperatorSpec.SecretExpressions)
}
