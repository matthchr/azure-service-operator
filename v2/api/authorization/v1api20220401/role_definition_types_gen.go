...
func (definition *RoleDefinition) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(nil, definition.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (definition *RoleDefinition) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(nil, definition.Spec.OperatorSpec.SecretExpressions)
}
