...
func (route *Route) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(nil, route.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (route *Route) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(nil, route.Spec.OperatorSpec.SecretExpressions)
}
