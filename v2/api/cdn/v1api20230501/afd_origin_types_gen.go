...
func (origin *AfdOrigin) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(nil, origin.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (origin *AfdOrigin) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(nil, origin.Spec.OperatorSpec.SecretExpressions)
}
