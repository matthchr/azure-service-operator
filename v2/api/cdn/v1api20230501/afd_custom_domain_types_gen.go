...
func (domain *AfdCustomDomain) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(nil, domain.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (domain *AfdCustomDomain) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(nil, domain.Spec.OperatorSpec.SecretExpressions)
}
