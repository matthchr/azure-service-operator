...
func (secret *Secret) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(nil, secret.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (secret *Secret) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(nil, secret.Spec.OperatorSpec.SecretExpressions)
}
