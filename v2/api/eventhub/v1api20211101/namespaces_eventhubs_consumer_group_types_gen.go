...
func (group *NamespacesEventhubsConsumerGroup) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(nil, group.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (group *NamespacesEventhubsConsumerGroup) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(nil, group.Spec.OperatorSpec.SecretExpressions)
}
...
func (consumergroup *Namespaces_Eventhubs_Consumergroup_Spec) AssignProperties_From_Namespaces_Eventhubs_Consumergroup_Spec(source *storage.Namespaces_Eventhubs_Consumergroup_Spec) error {
	...
	if source.OperatorSpec != nil {
		...
		consumergroup.OperatorSpec = &operatorSpec
	} else {
		consumergroup.OperatorSpec = nil
	}
...
func (consumergroup *Namespaces_Eventhubs_Consumergroup_Spec) AssignProperties_To_Namespaces_Eventhubs_Consumergroup_Spec(destination *storage.Namespaces_Eventhubs_Consumergroup_Spec) error {
	...
	// OperatorSpec
	if consumergroup.OperatorSpec != nil {
		var operatorSpec storage.NamespacesEventhubsConsumerGroupOperatorSpec
		err := consumergroup.OperatorSpec.AssignProperties_To_NamespacesEventhubsConsumerGroupOperatorSpec(&operatorSpec)
		if err != nil {
