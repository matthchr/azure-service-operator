...
func (eventhub *NamespacesEventhub) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(nil, eventhub.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (eventhub *NamespacesEventhub) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(nil, eventhub.Spec.OperatorSpec.SecretExpressions)
}
