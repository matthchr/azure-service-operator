...
func (namespace *Namespace) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(nil, namespace.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (namespace *Namespace) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(toValidate, namespace.Spec.OperatorSpec.SecretExpressions)
}
