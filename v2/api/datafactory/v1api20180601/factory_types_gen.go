...
func (factory *Factory) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(nil, factory.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (factory *Factory) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(nil, factory.Spec.OperatorSpec.SecretExpressions)
}
