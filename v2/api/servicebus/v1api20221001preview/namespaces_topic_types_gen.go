...
func (topic *NamespacesTopic) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(nil, topic.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (topic *NamespacesTopic) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(nil, topic.Spec.OperatorSpec.SecretExpressions)
}
