...
func (queue *NamespacesQueue) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(nil, queue.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (queue *NamespacesQueue) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(nil, queue.Spec.OperatorSpec.SecretExpressions)
}
