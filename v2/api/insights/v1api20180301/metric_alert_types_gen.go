...
func (alert *MetricAlert) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(nil, alert.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (alert *MetricAlert) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(nil, alert.Spec.OperatorSpec.SecretExpressions)
}
