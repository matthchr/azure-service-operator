...
func (component *Component) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(toValidate, component.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (component *Component) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(nil, component.Spec.OperatorSpec.SecretExpressions)
}
