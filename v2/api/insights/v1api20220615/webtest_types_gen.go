...
func (webtest *Webtest) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(nil, webtest.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (webtest *Webtest) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(nil, webtest.Spec.OperatorSpec.SecretExpressions)
}
