...
func (topic *Topic) ExportKubernetesConfigMaps(_ context.Context) ([]client.Object, error) {
...
func (topic *Topic) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(toValidate, topic.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (topic *Topic) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(toValidate, topic.Spec.OperatorSpec.SecretExpressions)
}
