...
func (server *FlexibleServer) ExportKubernetesConfigMaps(_ context.Context) ([]client.Object, error) {
...
func (server *FlexibleServer) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(toValidate, server.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (server *FlexibleServer) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(toValidate, server.Spec.OperatorSpec.SecretExpressions)
}
