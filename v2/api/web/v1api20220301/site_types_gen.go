...
func (site *Site) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(nil, site.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (site *Site) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(nil, site.Spec.OperatorSpec.SecretExpressions)
}
