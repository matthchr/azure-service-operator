...
func (database *SqlDatabase) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(nil, database.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (database *SqlDatabase) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(nil, database.Spec.OperatorSpec.SecretExpressions)
}
