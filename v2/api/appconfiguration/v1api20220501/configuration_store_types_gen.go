...
func (store *ConfigurationStore) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(nil, store.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (store *ConfigurationStore) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(toValidate, store.Spec.OperatorSpec.SecretExpressions)
}
