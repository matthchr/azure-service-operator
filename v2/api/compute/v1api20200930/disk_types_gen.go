...
func (disk *Disk) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(nil, disk.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (disk *Disk) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(nil, disk.Spec.OperatorSpec.SecretExpressions)
}
