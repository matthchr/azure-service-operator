...
func (access *DiskAccess) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(nil, access.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (access *DiskAccess) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(nil, access.Spec.OperatorSpec.SecretExpressions)
}
