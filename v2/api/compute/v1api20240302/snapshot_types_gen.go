...
func (snapshot *Snapshot) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(nil, snapshot.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (snapshot *Snapshot) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(nil, snapshot.Spec.OperatorSpec.SecretExpressions)
}
