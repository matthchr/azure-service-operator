...
func (machine *VirtualMachine) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(nil, machine.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (machine *VirtualMachine) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(nil, machine.Spec.OperatorSpec.SecretExpressions)
}
