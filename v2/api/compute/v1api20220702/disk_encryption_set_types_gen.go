...
func (encryptionSet *DiskEncryptionSet) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(nil, encryptionSet.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (encryptionSet *DiskEncryptionSet) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(nil, encryptionSet.Spec.OperatorSpec.SecretExpressions)
}
