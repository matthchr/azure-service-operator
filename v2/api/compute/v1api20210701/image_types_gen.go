...
func (image *Image) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(nil, image.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (image *Image) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(nil, image.Spec.OperatorSpec.SecretExpressions)
}
