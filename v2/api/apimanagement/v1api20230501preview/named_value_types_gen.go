...
func (value *NamedValue) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(nil, value.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (value *NamedValue) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(nil, value.Spec.OperatorSpec.SecretExpressions)
}
