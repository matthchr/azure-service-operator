...
func (productApi *ProductApi) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(nil, productApi.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (productApi *ProductApi) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(nil, productApi.Spec.OperatorSpec.SecretExpressions)
}
...
func (productsApi *Service_Products_Api_Spec) AssignProperties_From_Service_Products_Api_Spec(source *storage.Service_Products_Api_Spec) error {
	...
	if source.OperatorSpec != nil {
		...
		productsApi.OperatorSpec = &operatorSpec
	} else {
		productsApi.OperatorSpec = nil
	}
...
func (productsApi *Service_Products_Api_Spec) AssignProperties_To_Service_Products_Api_Spec(destination *storage.Service_Products_Api_Spec) error {
	...
	// OperatorSpec
	if productsApi.OperatorSpec != nil {
		var operatorSpec storage.ProductApiOperatorSpec
		err := productsApi.OperatorSpec.AssignProperties_To_ProductApiOperatorSpec(&operatorSpec)
		if err != nil {
