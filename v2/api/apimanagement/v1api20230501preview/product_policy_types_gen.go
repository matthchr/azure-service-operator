...
func (policy *ProductPolicy) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(nil, policy.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (policy *ProductPolicy) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(nil, policy.Spec.OperatorSpec.SecretExpressions)
}
