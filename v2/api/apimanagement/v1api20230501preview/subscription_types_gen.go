...
func (subscription *Subscription) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(nil, subscription.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (subscription *Subscription) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(toValidate, subscription.Spec.OperatorSpec.SecretExpressions)
}
