...
// We first initialize service_Product_SpecGenerator with a simplified generator based on the
...
func Service_Product_SpecGenerator() gopter.Gen {
	...
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForService_Product_Spec(generators)
	AddRelatedPropertyGeneratorsForService_Product_Spec(generators)
	service_Product_SpecGenerator = gen.Struct(reflect.TypeOf(Service_Product_Spec{}), generators)
...
// AddRelatedPropertyGeneratorsForService_Product_Spec is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForService_Product_Spec(gens map[string]gopter.Gen) {
