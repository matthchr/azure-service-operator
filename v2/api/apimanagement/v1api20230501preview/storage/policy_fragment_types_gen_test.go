...
// We first initialize service_PolicyFragment_SpecGenerator with a simplified generator based on the
...
func Service_PolicyFragment_SpecGenerator() gopter.Gen {
	...
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForService_PolicyFragment_Spec(generators)
	AddRelatedPropertyGeneratorsForService_PolicyFragment_Spec(generators)
	service_PolicyFragment_SpecGenerator = gen.Struct(reflect.TypeOf(Service_PolicyFragment_Spec{}), generators)
...
// AddRelatedPropertyGeneratorsForService_PolicyFragment_Spec is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForService_PolicyFragment_Spec(gens map[string]gopter.Gen) {
