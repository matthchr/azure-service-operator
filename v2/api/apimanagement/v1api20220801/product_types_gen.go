...
func (product *Product) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(nil, product.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (product *Product) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(nil, product.Spec.OperatorSpec.SecretExpressions)
}
