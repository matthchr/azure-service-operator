...
func (versionSet *ApiVersionSet) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(nil, versionSet.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (versionSet *ApiVersionSet) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(nil, versionSet.Spec.OperatorSpec.SecretExpressions)
}
