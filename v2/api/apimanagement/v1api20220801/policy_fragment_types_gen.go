...
func (fragment *PolicyFragment) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(nil, fragment.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (fragment *PolicyFragment) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(nil, fragment.Spec.OperatorSpec.SecretExpressions)
}
