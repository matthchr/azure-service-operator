...
func (backend *Backend) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(nil, backend.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (backend *Backend) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(nil, backend.Spec.OperatorSpec.SecretExpressions)
}
