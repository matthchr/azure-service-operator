...
func (service *SearchService) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(nil, service.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (service *SearchService) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(toValidate, service.Spec.OperatorSpec.SecretExpressions)
}
