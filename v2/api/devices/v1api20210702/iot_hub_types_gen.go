...
func (iotHub *IotHub) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(nil, iotHub.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (iotHub *IotHub) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(toValidate, iotHub.Spec.OperatorSpec.SecretExpressions)
}
