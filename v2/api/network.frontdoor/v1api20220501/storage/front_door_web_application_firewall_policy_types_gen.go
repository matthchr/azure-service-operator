...
// +kubebuilder:rbac:groups=network.frontdoor.azure.com,resources=frontdoorwebapplicationfirewallpolicies,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=network.frontdoor.azure.com,resources={frontdoorwebapplicationfirewallpolicies/status,frontdoorwebapplicationfirewallpolicies/finalizers},verbs=get;update;patch
...
// Storage version of v1api20220501.FrontDoorWebApplicationFirewallPolicy
...
// Hub marks that this FrontDoorWebApplicationFirewallPolicy is the hub type for conversion
func (policy *FrontDoorWebApplicationFirewallPolicy) Hub() {}
