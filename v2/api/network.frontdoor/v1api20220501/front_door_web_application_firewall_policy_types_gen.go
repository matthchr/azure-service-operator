...
var _ conditions.Conditioner = &FrontDoorWebApplicationFirewallPolicy{}

// GetConditions returns the conditions of the resource
func (policy *FrontDoorWebApplicationFirewallPolicy) GetConditions() conditions.Conditions {
	return policy.Status.Conditions
}

// SetConditions sets the conditions on the resource status
func (policy *FrontDoorWebApplicationFirewallPolicy) SetConditions(conditions conditions.Conditions) {
	policy.Status.Conditions = conditions
}

var _ conversion.Convertible = &FrontDoorWebApplicationFirewallPolicy{}

// ConvertFrom populates our FrontDoorWebApplicationFirewallPolicy from the provided hub FrontDoorWebApplicationFirewallPolicy
func (policy *FrontDoorWebApplicationFirewallPolicy) ConvertFrom(hub conversion.Hub) error {
	source, ok := hub.(*v20220501s.FrontDoorWebApplicationFirewallPolicy)
	if !ok {
		return fmt.Errorf("expected network.frontdoor/v1api20220501/storage/FrontDoorWebApplicationFirewallPolicy but received %T instead", hub)
	}

	return policy.AssignProperties_From_FrontDoorWebApplicationFirewallPolicy(source)
}

// ConvertTo populates the provided hub FrontDoorWebApplicationFirewallPolicy from our FrontDoorWebApplicationFirewallPolicy
func (policy *FrontDoorWebApplicationFirewallPolicy) ConvertTo(hub conversion.Hub) error {
	destination, ok := hub.(*v20220501s.FrontDoorWebApplicationFirewallPolicy)
	if !ok {
		return fmt.Errorf("expected network.frontdoor/v1api20220501/storage/FrontDoorWebApplicationFirewallPolicy but received %T instead", hub)
	}

	return policy.AssignProperties_To_FrontDoorWebApplicationFirewallPolicy(destination)
}

// +kubebuilder:webhook:path=/mutate-network-frontdoor-azure-com-v1api20220501-frontdoorwebapplicationfirewallpolicy,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=network.frontdoor.azure.com,resources=frontdoorwebapplicationfirewallpolicies,verbs=create;update,versions=v1api20220501,name=default.v1api20220501.frontdoorwebapplicationfirewallpolicies.network.frontdoor.azure.com,admissionReviewVersions=v1

var _ admission.Defaulter = &FrontDoorWebApplicationFirewallPolicy{}

// Default applies defaults to the FrontDoorWebApplicationFirewallPolicy resource
func (policy *FrontDoorWebApplicationFirewallPolicy) Default() {
	policy.defaultImpl()
	var temp any = policy
...
func (policy *FrontDoorWebApplicationFirewallPolicy) defaultAzureName() {
	if policy.Spec.AzureName == "" {
		policy.Spec.AzureName = policy.Name
	}
}

// defaultImpl applies the code generated defaults to the FrontDoorWebApplicationFirewallPolicy resource
func (policy *FrontDoorWebApplicationFirewallPolicy) defaultImpl() { policy.defaultAzureName() }

var _ genruntime.ImportableResource = &FrontDoorWebApplicationFirewallPolicy{}

// InitializeSpec initializes the spec for this resource from the given status
func (policy *FrontDoorWebApplicationFirewallPolicy) InitializeSpec(status genruntime.ConvertibleStatus) error {
...
var _ genruntime.KubernetesResource = &FrontDoorWebApplicationFirewallPolicy{}

// AzureName returns the Azure name of the resource
func (policy *FrontDoorWebApplicationFirewallPolicy) AzureName() string {
	return policy.Spec.AzureName
}

// GetAPIVersion returns the ARM API version of the resource. This is always "2022-05-01"
func (policy FrontDoorWebApplicationFirewallPolicy) GetAPIVersion() string {
	return string(APIVersion_Value)
}

// GetResourceScope returns the scope of the resource
func (policy *FrontDoorWebApplicationFirewallPolicy) GetResourceScope() genruntime.ResourceScope {
	return genruntime.ResourceScopeResourceGroup
}

// GetSpec returns the specification of this resource
func (policy *FrontDoorWebApplicationFirewallPolicy) GetSpec() genruntime.ConvertibleSpec {
	return &policy.Spec
}

// GetStatus returns the status of this resource
func (policy *FrontDoorWebApplicationFirewallPolicy) GetStatus() genruntime.ConvertibleStatus {
	return &policy.Status
}

// GetSupportedOperations returns the operations supported by the resource
func (policy *FrontDoorWebApplicationFirewallPolicy) GetSupportedOperations() []genruntime.ResourceOperation {
...
func (policy *FrontDoorWebApplicationFirewallPolicy) GetType() string {
	return "Microsoft.Network/FrontDoorWebApplicationFirewallPolicies"
}

// NewEmptyStatus returns a new empty (blank) status
func (policy *FrontDoorWebApplicationFirewallPolicy) NewEmptyStatus() genruntime.ConvertibleStatus {
	return &FrontDoorWebApplicationFirewallPolicy_STATUS{}
}

// Owner returns the ResourceReference of the owner
func (policy *FrontDoorWebApplicationFirewallPolicy) Owner() *genruntime.ResourceReference {
	group, kind := genruntime.LookupOwnerGroupKind(policy.Spec)
	return policy.Spec.Owner.AsResourceReference(group, kind)
}

// SetStatus sets the status of this resource
func (policy *FrontDoorWebApplicationFirewallPolicy) SetStatus(status genruntime.ConvertibleStatus) error {
...
// +kubebuilder:webhook:path=/validate-network-frontdoor-azure-com-v1api20220501-frontdoorwebapplicationfirewallpolicy,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=network.frontdoor.azure.com,resources=frontdoorwebapplicationfirewallpolicies,verbs=create;update,versions=v1api20220501,name=validate.v1api20220501.frontdoorwebapplicationfirewallpolicies.network.frontdoor.azure.com,admissionReviewVersions=v1

var _ admission.Validator = &FrontDoorWebApplicationFirewallPolicy{}

// ValidateCreate validates the creation of the resource
func (policy *FrontDoorWebApplicationFirewallPolicy) ValidateCreate() (admission.Warnings, error) {
...
func (policy *FrontDoorWebApplicationFirewallPolicy) ValidateDelete() (admission.Warnings, error) {
...
func (policy *FrontDoorWebApplicationFirewallPolicy) ValidateUpdate(old runtime.Object) (admission.Warnings, error) {
...
func (policy *FrontDoorWebApplicationFirewallPolicy) createValidations() []func() (admission.Warnings, error) {
	return []func() (admission.Warnings, error){policy.validateResourceReferences, policy.validateOwnerReference}
}

// deleteValidations validates the deletion of the resource
func (policy *FrontDoorWebApplicationFirewallPolicy) deleteValidations() []func() (admission.Warnings, error) {
	return nil
}

// updateValidations validates the update of the resource
func (policy *FrontDoorWebApplicationFirewallPolicy) updateValidations() []func(old runtime.Object) (admission.Warnings, error) {
...
func (policy *FrontDoorWebApplicationFirewallPolicy) validateOwnerReference() (admission.Warnings, error) {
	return genruntime.ValidateOwner(policy)
}

// validateResourceReferences validates all resource references
func (policy *FrontDoorWebApplicationFirewallPolicy) validateResourceReferences() (admission.Warnings, error) {
...
func (policy *FrontDoorWebApplicationFirewallPolicy) validateWriteOnceProperties(old runtime.Object) (admission.Warnings, error) {
	oldObj, ok := old.(*FrontDoorWebApplicationFirewallPolicy)
	if !ok {
		return nil, nil
	}
...
// AssignProperties_From_FrontDoorWebApplicationFirewallPolicy populates our FrontDoorWebApplicationFirewallPolicy from the provided source FrontDoorWebApplicationFirewallPolicy
func (policy *FrontDoorWebApplicationFirewallPolicy) AssignProperties_From_FrontDoorWebApplicationFirewallPolicy(source *v20220501s.FrontDoorWebApplicationFirewallPolicy) error {
...
// AssignProperties_To_FrontDoorWebApplicationFirewallPolicy populates the provided destination FrontDoorWebApplicationFirewallPolicy from our FrontDoorWebApplicationFirewallPolicy
func (policy *FrontDoorWebApplicationFirewallPolicy) AssignProperties_To_FrontDoorWebApplicationFirewallPolicy(destination *v20220501s.FrontDoorWebApplicationFirewallPolicy) error {
...
func (policy *FrontDoorWebApplicationFirewallPolicy) OriginalGVK() *schema.GroupVersionKind {
	return &schema.GroupVersionKind{
		Group:   GroupVersion.Group,
		Version: policy.Spec.OriginalVersion(),
		Kind:    "FrontDoorWebApplicationFirewallPolicy",
	}
}
...
// - Generated from: /frontdoor/resource-manager/Microsoft.Network/stable/2022-05-01/webapplicationfirewall.json
// - ARM URI: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/FrontDoorWebApplicationFirewallPolicies/{policyName}
type FrontDoorWebApplicationFirewallPolicyList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []FrontDoorWebApplicationFirewallPolicy `json:"items"`
}
...
func init() {
	SchemeBuilder.Register(&FrontDoorWebApplicationFirewallPolicy{}, &FrontDoorWebApplicationFirewallPolicyList{})
}
