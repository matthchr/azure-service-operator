...
func Test_FrontDoorWebApplicationFirewallPolicy_WhenConvertedToHub_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties.Property(
		"Round trip from FrontDoorWebApplicationFirewallPolicy to hub returns original",
		prop.ForAll(RunResourceConversionTestForFrontDoorWebApplicationFirewallPolicy, FrontDoorWebApplicationFirewallPolicyGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunResourceConversionTestForFrontDoorWebApplicationFirewallPolicy tests if a specific instance of FrontDoorWebApplicationFirewallPolicy round trips to the hub storage version and back losslessly
func RunResourceConversionTestForFrontDoorWebApplicationFirewallPolicy(subject FrontDoorWebApplicationFirewallPolicy) string {
	// Copy subject to make sure conversion doesn't modify it
	copied := subject.DeepCopy()

	// Convert to our hub version
	var hub v20220501s.FrontDoorWebApplicationFirewallPolicy
	...
	var actual FrontDoorWebApplicationFirewallPolicy
...
func Test_FrontDoorWebApplicationFirewallPolicy_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from FrontDoorWebApplicationFirewallPolicy to FrontDoorWebApplicationFirewallPolicy via AssignProperties_To_FrontDoorWebApplicationFirewallPolicy & AssignProperties_From_FrontDoorWebApplicationFirewallPolicy returns original",
		prop.ForAll(RunPropertyAssignmentTestForFrontDoorWebApplicationFirewallPolicy, FrontDoorWebApplicationFirewallPolicyGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForFrontDoorWebApplicationFirewallPolicy tests if a specific instance of FrontDoorWebApplicationFirewallPolicy can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForFrontDoorWebApplicationFirewallPolicy(subject FrontDoorWebApplicationFirewallPolicy) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20220501s.FrontDoorWebApplicationFirewallPolicy
	err := copied.AssignProperties_To_FrontDoorWebApplicationFirewallPolicy(&other)
	if err != nil {
		return err.Error()
	}
	...
	var actual FrontDoorWebApplicationFirewallPolicy
	err = actual.AssignProperties_From_FrontDoorWebApplicationFirewallPolicy(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_FrontDoorWebApplicationFirewallPolicy_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of FrontDoorWebApplicationFirewallPolicy via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForFrontDoorWebApplicationFirewallPolicy, FrontDoorWebApplicationFirewallPolicyGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForFrontDoorWebApplicationFirewallPolicy runs a test to see if a specific instance of FrontDoorWebApplicationFirewallPolicy round trips to JSON and back losslessly
func RunJSONSerializationTestForFrontDoorWebApplicationFirewallPolicy(subject FrontDoorWebApplicationFirewallPolicy) string {
	// Serialize to JSON
...
// Generator of FrontDoorWebApplicationFirewallPolicy instances for property testing - lazily instantiated by
// FrontDoorWebApplicationFirewallPolicyGenerator()
var frontDoorWebApplicationFirewallPolicyGenerator gopter.Gen

// FrontDoorWebApplicationFirewallPolicyGenerator returns a generator of FrontDoorWebApplicationFirewallPolicy instances for property testing.
func FrontDoorWebApplicationFirewallPolicyGenerator() gopter.Gen {
	if frontDoorWebApplicationFirewallPolicyGenerator != nil {
		return frontDoorWebApplicationFirewallPolicyGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddRelatedPropertyGeneratorsForFrontDoorWebApplicationFirewallPolicy(generators)
	frontDoorWebApplicationFirewallPolicyGenerator = gen.Struct(reflect.TypeOf(FrontDoorWebApplicationFirewallPolicy{}), generators)

	return frontDoorWebApplicationFirewallPolicyGenerator
}

// AddRelatedPropertyGeneratorsForFrontDoorWebApplicationFirewallPolicy is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForFrontDoorWebApplicationFirewallPolicy(gens map[string]gopter.Gen) {
