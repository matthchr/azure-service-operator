...
func (member *FleetsMember) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(nil, member.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (member *FleetsMember) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(nil, member.Spec.OperatorSpec.SecretExpressions)
}
