...
func (fleet *Fleet) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(nil, fleet.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (fleet *Fleet) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(toValidate, fleet.Spec.OperatorSpec.SecretExpressions)
}
