...
func (updateRun *FleetsUpdateRun) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(nil, updateRun.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (updateRun *FleetsUpdateRun) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(nil, updateRun.Spec.OperatorSpec.SecretExpressions)
}
