...
func (cluster *ManagedCluster) ExportKubernetesConfigMaps(_ context.Context) ([]client.Object, error) {
...
func (cluster *ManagedCluster) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(toValidate, cluster.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (cluster *ManagedCluster) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(toValidate, cluster.Spec.OperatorSpec.SecretExpressions)
}
