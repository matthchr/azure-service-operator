...
func (alias *Alias) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(nil, alias.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (alias *Alias) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(nil, alias.Spec.OperatorSpec.SecretExpressions)
}
