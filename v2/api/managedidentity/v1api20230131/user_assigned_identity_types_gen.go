...
func (identity *UserAssignedIdentity) ExportKubernetesConfigMaps(_ context.Context) ([]client.Object, error) {
...
func (identity *UserAssignedIdentity) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	return configmaps.ValidateDestinations(toValidate, identity.Spec.OperatorSpec.ConfigMapExpressions)
}
...
func (identity *UserAssignedIdentity) validateSecretDestinations() (admission.Warnings, error) {
	...
	return secrets.ValidateDestinations(toValidate, identity.Spec.OperatorSpec.SecretExpressions)
}
