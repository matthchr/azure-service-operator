...
// We first initialize userAssignedIdentities_FederatedIdentityCredential_SpecGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func UserAssignedIdentities_FederatedIdentityCredential_SpecGenerator() gopter.Gen {
	...
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForUserAssignedIdentities_FederatedIdentityCredential_Spec(generators)
	AddRelatedPropertyGeneratorsForUserAssignedIdentities_FederatedIdentityCredential_Spec(generators)
	userAssignedIdentities_FederatedIdentityCredential_SpecGenerator = gen.Struct(reflect.TypeOf(UserAssignedIdentities_FederatedIdentityCredential_Spec{}), generators)
...
// AddRelatedPropertyGeneratorsForUserAssignedIdentities_FederatedIdentityCredential_Spec is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForUserAssignedIdentities_FederatedIdentityCredential_Spec(gens map[string]gopter.Gen) {
