...
//
//type ExpressionClassification string
//
//const (
//	ExpressionClassificationString = ExpressionClassification("string")
//	ExpressionClassificationMap = ExpressionClassification("map")
//)
...
// The program cache is used to avoid re-evaluating expressions or Envs
// more than necessary.
...
// TODO: Need to use this someplace
