...
//	            ...
//	    }
//	    return <validatePkg>.<validateFunctionName>(toValidate, <receiver>.Spec.OperatorSpec.<expressionsProperty>)
//	}
func validateOperatorSpecSliceBody(
	...
	// return <validatePkg>.<validateFunctionName>(toValidate, expressionsToValidate)
	body = append(
		body,
		astbuilder.Returns(
