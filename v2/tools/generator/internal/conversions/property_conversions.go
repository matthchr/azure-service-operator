...
func init() {
	propertyConversionFactories = []PropertyConversionFactory{
		...
		copyKnownType(astmodel.SecretDestinationExpressionsType, "DeepCopy", returnsReference),
		copyKnownType(astmodel.ConfigMapDestinationExpressionsType, "DeepCopy", returnsReference),
