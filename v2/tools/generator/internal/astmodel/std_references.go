...
var (
	...
	ConfigMapDestinationExpressionsType = MakeExternalTypeName(GenRuntimeConfigMapsReference, "DestinationExpressions")
	ConfigMapExporterType               = MakeExternalTypeName(GenRuntimeConfigMapsReference, "Exporter")
	SecretDestinationExpressionsType    = MakeExternalTypeName(GenRuntimeSecretsReference, "DestinationExpressions")
