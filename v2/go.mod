...
require (
	...
	github.com/google/cel-go v0.21.1-0.20240909232413-d561d0a3be82 // This is pinned to the commit for https://github.com/google/cel-go/pull/1009, we should update to an official release when we can
...
// TODO: Remove this replace when upstream merges my changes
replace github.com/google/cel-go => github.com/matthchr/cel-go v0.0.0-20241014180305-bd921078b4c3
